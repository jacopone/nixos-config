# NPM tool versions - pinned for reproducibility
# Last updated: 2026-01-28
# To update: run scripts/update-npm-versions.sh or manually check npm view <package> version
{
  agent-browser = "0.8.4"; # Vercel Labs headless browser CLI for AI agents
