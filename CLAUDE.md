...
- `modules/core/packages.nix` - System-wide packages (25 tools)
...
- **System-level tools**: Universal access for AI agents (25 tools in `packages.nix`)
...
## System Status
- **Git Status**: 1M 0A 0U
- **Last Updated**: 2025-09-30 07:25:33
- **Fish Abbreviations**: 57
- **Total System Tools**: 25
