...
**Status**: 1/1 connected | Last checked: 2025-11-25 23:27:32
...
**Installed**: 141 tools | **Used**: 17 (12%) | **Analysis period**: 30 days

**Top 5 tools**:
- **git**: 41 uses (H:41 C:0)
- **devenv**: 31 uses (H:31 C:0)
- **brownfield**: 16 uses (H:16 C:0)
