...
**Last Updated**: 2025-11-03 22:57:28
**Analysis Period**: 30 days
**Total Commands Tracked**: 217
...
**claude-flow** - 3 uses- Human: 3 | Claude: 0 | Scripts: 0
   - Last used: 2025-11-03
...
**bat** - 8 uses- Better cat with syntax highlighting
...
**git** - 67 uses- A free and open source distributed version control system
- Human: 67 | Claude: 0 | Scripts: 0
   - Last used: 2025-11-03
...
- ⚠️ Never used in last 30 days
   - Location: line 176 in packages.nix
...
**Action**: Consider removing: helix, zed-editor, vscode-fhs, system, nodejs_20, and 43 more
...
**Action**: Consider removing: ripgrep, fd, dust, procs, dua, and 7 more
...
**Type**: Remove Dormant
**Issue**: 3 ai-tools tools unused in last 90 days
**Action**: Consider removing: serena, whisper-cpp, mcp-nixos
...
**Issue**: Highly used: 67 invocations (human: 67, Claude: 0)
...
- **Other**: 122 invocations
- **Ai Tools**: 55 invocations
- **Modern Cli**: 39 invocations
